...
if ( TRACE ) { TRACE( "ButtonPulse#StopPulse", this ); }
    ...
    Bridge.define("CanvasGroupAnimator", {
        ...
        ctors: {
            init: function () {
if ( TRACE ) { TRACE( "CanvasGroupAnimator#init", this ); }
...
if ( TRACE ) { TRACE( "CanvasGroupAnimator#TriggerAnimate", this ); }
...
if ( TRACE ) { TRACE( "CanvasGroupAnimator#TriggerAnimateOut", this ); }
...
if ( TRACE ) { TRACE( "CanvasGroupAnimator#TriggerAnimateSprite", this ); }
            ...
            OnEnable: function () {
if ( TRACE ) { TRACE( "CanvasGroupAnimator#OnEnable", this ); }
...
if ( TRACE ) { TRACE( "GameManager#Start", this ); }
            ...
            ShowPrompt: function () {
if ( TRACE ) { TRACE( "GameManager#ShowPrompt", this ); }
...
if ( TRACE ) { TRACE( "GameManager#ShowPrompt_L", this ); }
            ...
            Win_P: function () {
if ( TRACE ) { TRACE( "GameManager#Win_P", this ); }
...
if ( TRACE ) { TRACE( "GameManager#Win_P_Short", this ); }
...
if ( TRACE ) { TRACE( "GameManager#Win_L_Short", this ); }
            ...
            Win_L: function () {
if ( TRACE ) { TRACE( "GameManager#Win_L", this ); }
...
if ( TRACE ) { TRACE( "HorizontalUIDragClamp#GetWorldSizeInParent", this ); }
...
if ( TRACE ) { TRACE( "HorizontalUIDragClamp#Awake", this ); }
            ...
            OnEnable: function () {
if ( TRACE ) { TRACE( "HorizontalUIDragClamp#OnEnable", this ); }
            ...
            OnDisable: function () {
if ( TRACE ) { TRACE( "HorizontalUIDragClamp#OnDisable", this ); }
...
if ( TRACE ) { TRACE( "HorizontalUIDragClamp#OnTransformParentChanged", this ); }
            ...
            Cache: function () {
if ( TRACE ) { TRACE( "HorizontalUIDragClamp#Cache", this ); }
...
if ( TRACE ) { TRACE( "HorizontalUIDragClamp#OnPointerDown", this ); }
...
if ( TRACE ) { TRACE( "HorizontalUIDragClamp#IsPointerOnSelfOrChild", this ); }
...
if ( TRACE ) { TRACE( "HorizontalUIDragClamp#ScreenPointToParentLocalX", this ); }
...
if ( TRACE ) { TRACE( "HorizontalUIDragClamp#GetSelfCenterLocalX", this ); }
...
if ( TRACE ) { TRACE( "HorizontalUIDragClamp#ComputeEffectivePaddingsLocal", this ); }
    ...
    Bridge.define("ImageHandler", {
        ...
        methods: {
            ...
            Awake: function () {
if ( TRACE ) { TRACE( "ImageHandler#Awake", this ); }
...
if ( TRACE ) { TRACE( "ImageHandler#OnPointerClick", this ); }
...
if ( TRACE ) { TRACE( "ImageHandler#ToggleChild", this ); }
...
if ( TRACE ) { TRACE( "ImageHandler#ToggleImageMaterial", this ); }
    ...
    Bridge.define("MaskProBuiltIn", {
        ...
        statics: {
            ...
            ctors: {
                init: function () {
if ( TRACE ) { TRACE( "MaskProBuiltIn#init", this ); }
...
if ( TRACE ) { TRACE( "MaskProBuiltIn#GetOrAdd", this ); }
...
if ( TRACE ) { TRACE( "MaskProBuiltIn#init", this ); }
        ...
        methods: {
            ...
            OnEnable: function () {
if ( TRACE ) { TRACE( "MaskProBuiltIn#OnEnable", this ); }
            ...
            OnDisable: function () {
if ( TRACE ) { TRACE( "MaskProBuiltIn#OnDisable", this ); }
            ...
            OnDestroy: function () {
if ( TRACE ) { TRACE( "MaskProBuiltIn#OnDestroy", this ); }
            ...
            OnTransformParentChanged: function () {
if ( TRACE ) { TRACE( "MaskProBuiltIn#OnTransformParentChanged", this ); }
...
if ( TRACE ) { TRACE( "MaskProBuiltIn#OnCanvasHierarchyChanged", this ); }
            ...
            Cache: function () {
if ( TRACE ) { TRACE( "MaskProBuiltIn#Cache", this ); }
...
if ( TRACE ) { TRACE( "MaskProBuiltIn#AllocateStencilRef", this ); }
...
if ( TRACE ) { TRACE( "MaskProBuiltIn#ApplyWriter", this ); }
...
if ( TRACE ) { TRACE( "MaskProBuiltIn#ResolveTargets", this ); }
...
if ( TRACE ) { TRACE( "MaskProBuiltIn#ApplyReaders", this ); }
...
if ( TRACE ) { TRACE( "MaskProBuiltIn#FixDrawOrder", this ); }
...
if ( TRACE ) { TRACE( "MaskProBuiltIn#ApplyToGraphicReplacing", this ); }
...
if ( TRACE ) { TRACE( "MaskProBuiltIn#RemoveAppliedIfAny", this ); }
...
if ( TRACE ) { TRACE( "MaskProBuiltIn#RememberOriginal", this ); }
            ...
            RestoreAll: function () {
if ( TRACE ) { TRACE( "MaskProBuiltIn#RestoreAll", this ); }
...
if ( TRACE ) { TRACE( "OrientationLayoutSwitcher#ApplySafe", this ); }
    ...
    Bridge.define("PromtPopUp", {
        ...
        methods: {
            ...
            Start: function () {
if ( TRACE ) { TRACE( "PromtPopUp#Start", this ); }
...
if ( TRACE ) { TRACE( "ResponsiveUIManager.StrictAspectEntry#$clone", this ); }
    ...
    Bridge.define("SIPChecker_P", {
        ...
        methods: {
            ...
            Start: function () {
if ( TRACE ) { TRACE( "SIPChecker_P#Start", this ); }
            ...
            Update: function () {
if ( TRACE ) { TRACE( "SIPChecker_P#Update", this ); }
            ...
            EndGame: function () {
if ( TRACE ) { TRACE( "SIPChecker_P#EndGame", this ); }
            ...
            EndGam_L: function () {
if ( TRACE ) { TRACE( "SIPChecker_P#EndGam_L", this ); }
...
if ( TRACE ) { TRACE( "UIDropZoneDetector#OnTriggerEnter2D", this ); }
...
if ( TRACE ) { TRACE( "UIDropZoneDetector#OnTriggerExit2D", this ); }
...
if ( TRACE ) { TRACE( "UIDropZoneDetector#OnTriggerStay2D", this ); }
    ...
    Bridge.define("UIDropZoneDetector_L", {
        ...
        methods: {
            ...
            OnTriggerEnter2D: function (other) {
if ( TRACE ) { TRACE( "UIDropZoneDetector_L#OnTriggerEnter2D", this ); }
            ...
            OnTriggerExit2D: function (other) {
if ( TRACE ) { TRACE( "UIDropZoneDetector_L#OnTriggerExit2D", this ); }
            ...
            OnTriggerStay2D: function (other) {
if ( TRACE ) { TRACE( "UIDropZoneDetector_L#OnTriggerStay2D", this ); }
    ...
    Bridge.define("UIHorizontalMover", {
        ...
        ctors: {
            init: function () {
if ( TRACE ) { TRACE( "UIHorizontalMover#init", this ); }
        ...
        methods: {
            ...
            Awake: function () {
if ( TRACE ) { TRACE( "UIHorizontalMover#Awake", this ); }
...
if ( TRACE ) { TRACE( "UIHorizontalMover#MoveToRightEdge", this ); }
...
if ( TRACE ) { TRACE( "UIHorizontalMover#ResetPosition", this ); }
